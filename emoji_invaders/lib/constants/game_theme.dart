...
class GameTheme {
  ...
  static const Color spaceBackgroundAccentColor =
      Color(0xFF001133); // Slightly lighter space blue
  ...
  static const List<double> starSizes = [
    1.0,
    1.5,
    2.0
  ]; // Different star sizes in pixels
